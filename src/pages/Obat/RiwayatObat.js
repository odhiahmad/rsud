...
class RiwayatObat extends Component {
    constructor(props) {
        super(props);
        this.state = {
            refreshing: false,
    ...
    getData = async () => {
        ...
        const url = baseApi + '/user/getNotifikasiObatRiwayat?page=' + this.state.page;
        fetch(url, {
            method: 'POST',
            headers: {
...
export default connect(mapStateToProps, mapDispatchToProps)(RiwayatObat);
